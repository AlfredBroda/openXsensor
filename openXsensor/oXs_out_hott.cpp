...
// in general air module data to fill are:
              ...
              TxHottData.gamMsg.cell[0] =  voltageData->mVoltCell[0].value / 20 ; // Volt Cell 1 (in 2 mV increments, 210 == 4.20 V)
#endif
#if  defined(NUMBEROFCELLS) && (NUMBEROFCELLS >= 2)
              TxHottData.gamMsg.cell[1] =  voltageData->mVoltCell[1].value / 20 ; // Volt Cell 2 (in 2 mV increments, 210 == 4.20 V)
#endif
#if  defined(NUMBEROFCELLS) && (NUMBEROFCELLS >= 3)
              TxHottData.gamMsg.cell[2] =  voltageData->mVoltCell[2].value / 20 ; // Volt Cell 3 (in 2 mV increments, 210 == 4.20 V)
#endif
#if  defined(NUMBEROFCELLS) && (NUMBEROFCELLS >= 4)
             TxHottData.gamMsg.cell[3] =  voltageData->mVoltCell[3].value / 20 ; // Volt Cell 4 (in 2 mV increments, 210 == 4.20 V)
#endif
#if  defined(NUMBEROFCELLS) && (NUMBEROFCELLS >= 5)
              TxHottData.gamMsg.cell[4] =  voltageData->mVoltCell[4].value / 20 ; // Volt Cell 5 (in 2 mV increments, 210 == 4.20 V)
#endif
#if  defined(NUMBEROFCELLS) && (NUMBEROFCELLS >= 6)
              TxHottData.gamMsg.cell[5] =  voltageData->mVoltCell[5].value / 20 ; // Volt Cell 6 (in 2 mV increments, 210 == 4.20 V)
#endif
              ...
              TxHottData.gamMsg.min_cell_volt =  voltageData->mVoltCellMin.value / 20 ; // minimum cell voltage in 2mV steps. 124 = 2,48V
#endif
#if defined(NUMBEROFCELLS) && (NUMBEROFCELLS > 0) && defined(CELL_UNDERVOLTAGE_WARNING)
